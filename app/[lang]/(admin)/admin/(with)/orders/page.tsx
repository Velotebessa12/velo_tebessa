...
<div className="flex items-center gap-3 p-4 border-b border-gray-200">
  <div className="relative w-14 h-14 flex-shrink-0">
    <img
      src={selectedOrder?.items?.[0]?.product?.images?.[0] || "/api/placeholder/60/60"}
      alt="Product"
  ...
  <div className="flex-1 min-w-0">
    <div className="text-sm font-medium text-gray-900 truncate">
      {getTranslations(selectedOrder?.items?.[0]?.product?.translations, lang, "name") || "Undefined"}
    </div>
  </div>
  <div className="text-right flex-shrink-0">
    ...
    <div className="text-base font-semibold text-teal-700">
      {selectedOrder?.items?.[0]?.unitPrice?.toLocaleString() || 0} DA
    </div>
  </div>
</div>
...
<div className="px-4 py-3 border-b border-gray-200 space-y-2">
  <div className="flex justify-between text-sm">
    ...
    <span className="text-gray-900 font-medium">
      {selectedOrder?.subtotal?.toLocaleString() || 0} DA
    </span>
  </div>
  ...
  <div className="flex justify-between text-sm">
    ...
    <span className="text-gray-900 font-medium">
      {selectedOrder?.shippingPrice?.toLocaleString() || 0} DA
    </span>
  </div>
  ...
  {selectedOrder?.discountTotal > 0 && (
    <div className="flex justify-between text-sm">
      ...
      <span className="text-green-600 font-medium">
        -{selectedOrder.discountTotal.toLocaleString()} DA
      </span>
    </div>
  )}
...
<div className="p-4 space-y-4">
  ...
  <div className="grid grid-cols-1 xs:grid-cols-2 gap-4">
    <div className="flex flex-col gap-1.5">
      ...
      <select
        ...
        onChange={(e) => setSelectedOrder((prev : any) => ({ ...prev!, status: e.target.value}))}
    ...
    <div className="flex flex-col gap-1.5">
      ...
      <input
        ...
        onChange={(e) => setSelectedOrder((prev : any) => ({ ...prev!, fullName: e.target.value }))}
  ...
  <div className="grid grid-cols-1 xs:grid-cols-2 gap-4">
    <div className="flex flex-col gap-1.5">
      ...
      <input
        ...
        onChange={(e) => setSelectedOrder((prev : any) => ({ ...prev!, phoneNumber: e.target.value }))}
        className="px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all"
      />
    </div>
    <div className="flex flex-col gap-1.5">
      ...
      <input
        ...
        onChange={(e) => setSelectedOrder((prev : any) => ({ ...prev!, wilaya: e.target.value }))}
        className="px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all"
      />
    </div>
  </div>
  ...
  <div className="flex flex-col gap-1.5">
    ...
    <input
      ...
      onChange={(e) => setSelectedOrder((prev : any) => ({ ...prev!, commune: e.target.value }))}
      className="px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all"
    />
  </div>

  {/* Detailed Address */}
  {selectedOrder?.detailedAddress != null && (
    <div className="flex flex-col gap-1.5">
      <label className="text-sm font-medium text-gray-700">Adresse détaillée</label>
      <textarea
        value={selectedOrder.detailedAddress}
        onChange={(e) => setSelectedOrder((prev : any) => ({ ...prev!, detailedAddress: e.target.value }))}
        rows={3}
  ...
  {selectedOrder?.deliveryMethod != null && (
    <div className="flex flex-col gap-1.5">
      <label className="text-sm font-medium text-gray-700">Méthode de livraison</label>
      <input
        type="text"
        value={selectedOrder.deliveryMethod}
        onChange={(e) => setSelectedOrder((prev : any) => ({ ...prev!, deliveryMethod: e.target.value }))}
  ...
  {/* Shipping Company */}
  {selectedOrder?.shippingCompany != null && (
    <div className="flex flex-col gap-1.5">
      <label className="text-sm font-medium text-gray-700">Société de livraison</label>
      <select
        value={selectedOrder.shippingCompany}
        onChange={(e) => setSelectedOrder((prev : any) => ({ ...prev!, shippingCompany: e.target.value }))}
        className="px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all cursor-pointer"
      >
  ...
  {/* Station Code */}
  {selectedOrder?.station_code != null && (
    <div className="flex flex-col gap-1.5">
      ...
      <input
        ...
        className="px-3 py-2 border border-gray-300 rounded-md text-sm disabled:bg-gray-50 disabled:text-gray-400"
      />
    </div>
  )}

  {/* Tracking ID */}
  {selectedOrder?.trackingId != null && (
    <div className="flex flex-col gap-1.5">
      <label className="text-sm font-medium text-gray-700">Numéro de suivi</label>
      <input
        type="text"
        value={selectedOrder.trackingId}
        onChange={(e) => setSelectedOrder((prev : any) => ({ ...prev!, trackingId: e.target.value }))}
  ...
  {selectedOrder?.deliveredAt != null && (
    <div className="flex flex-col gap-1.5">
      <label className="text-sm font-medium text-gray-700">Livré le</label>
      <input
        type="datetime-local"
        value={new Date(selectedOrder.deliveredAt).toISOString().slice(0, 16)}
        onChange={(e) => setSelectedOrder((prev : any) => ({ ...prev!, deliveredAt: new Date(e.target.value) }))}
        className="px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all"
      />
    </div>
  )}
  ...
  {/* Order Note */}
  {selectedOrder?.orderNote != null && (
    <div className="flex flex-col gap-1.5">
      <label className="text-sm font-medium text-gray-700">Note de commande</label>
      <textarea
        value={selectedOrder.orderNote}
        onChange={(e) => setSelectedOrder((prev : any) => ({ ...prev!, orderNote: e.target.value }))}
  ...
  {/* Delivery Note */}
  {selectedOrder?.deliveryNote != null && (
    <div className="flex flex-col gap-1.5">
      <label className="text-sm font-medium text-gray-700">Notes de livraison</label>
      <div className="text-xs text-gray-500 mb-1">Ajouter une nouvelle note</div>
      <textarea
        value={selectedOrder.deliveryNote}
        onChange={(e) => setSelectedOrder((prev : any) => ({ ...prev!, deliveryNote: e.target.value }))}
...
<div className="flex justify-end gap-3 px-4 pb-4 pt-2">
  ...
  <button onClick={() => {
    const { id, ...data } = selectedOrder;
    editOrder(id, data);
  }} className="px-4 sm:px-5 py-2.5 bg-teal-500 text-white rounded-md text-sm font-medium hover:bg-teal-600 transition-colors">
    Enregistrer
  </button>
</div>
            </>
