      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-4 lg:6">
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
            <button onClick={() => router.push(`/${lang}/admin/orders`)} className="p-6 bg-gradient-to-br from-blue-500 to-cyan-600 rounded-2xl text-white hover:shadow-2xl hover:shadow-blue-500/30 transition-all duration-300 group">
              <ShoppingCart className="w-8 h-8 mb-3 group-hover:scale-110 transition-transform" />
              <h4 className="text-lg font-bold mb-1 hover:underline">Voir Commandes</h4>
              <p className="text-sm text-blue-100">
                Consulter et gérer les commandes
              </p>
            </button>

            <button onClick={() => router.push(`/${lang}/admin/products/new`)} className="p-6 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl text-white hover:shadow-2xl hover:shadow-emerald-500/30 transition-all duration-300 group">
              <Package className="w-8 h-8 mb-3 group-hover:scale-110 transition-transform" />
              <h4 className="text-lg font-bold mb-1 hover:underline">Ajouter Produit</h4>
              <p className="text-sm text-emerald-100">
                Enrichir votre catalogue
              </p>
            </button>

            <button onClick={() => router.push(`/${lang}/admin/inventory`)} className="p-6 bg-gradient-to-br from-orange-500 to-red-600 rounded-2xl text-white hover:shadow-2xl hover:shadow-orange-500/30 transition-all duration-300 group">
              <TrendingUp className="w-8 h-8 mb-3 group-hover:scale-110 transition-transform" />
              <h4 className="text-lg font-bold mb-1 hover:underline">Nouvelle Entrée Stock</h4>
