...
export default function InventoryManagementPage() {
 ...
 function openEditPopup(operation: any) {
  ...
  setSelectedProductId(operation.productId);
  setPurchasePrice(operation.price);
    ...
    <option value="OUT">OUT</option>
                  ...
                  >
                    ...
                    {products.map((p: any) => (
                      <option key={p.id} value={p.id}>
                        {getTranslations(p.translations, lang, "name")} - Stock:{" "}
                        {p.stock} - UnitPrice: {p.buyingPrice} Da
                      </option>
                    ))}
                  </select>
                </div>
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      value={purchasePrice}
                      onChange={(e) =>
                        setPurchasePrice(e.target.value as any as any)
                      }
                      placeholder="0"
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  />
                       ...
                       {/* PMP Calculator — full width, after all inputs */}
  <button
    type="button"
    onClick={() => {
  ...
  >
    ...
    Calculer le PMP
                ...
                <div className="flex gap-3 pt-1">
                  ...
                  <button
                    onClick={() => editOperation(selectedOperation.id , {})}
  ...
  if (product) {
    setPurchasePrice(product.buyingPrice);
  }
}}
      className="w-full border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-teal-400/30 focus:border-teal-400 transition"
    >
